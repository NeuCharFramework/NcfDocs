...
```csharp
    public interface IXncfRegister
    {
        ...
        /// <summary>
        /// Registration method, the order of registration determines the order in the interface
        /// </summary>
        ...
        /// <summary>
        /// Get the URL of other Area pages
        /// </summary>
        ...
        /// <summary>
        /// Register the current module at the startup of ConfigureServices
        /// </summary>
